    ...
    public class ThreeDimentionCabViewer : TrainCarViewer
    {
            ...
            : base(viewer, car)
        {
            ...
            if (car.CabView3D != null)
            {
                ...
                TrainCarShape = new PoseableShape(viewer, shapePath + '\0' + Path.GetDirectoryName(shapePath), car.CabView3D.ShapeDescriptorPath, car.WorldPosition, ShapeFlags.ShadowCaster | ShapeFlags.Interior);
