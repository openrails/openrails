    ...
    public class VolumeCurve
    {
        ...
        public VolumeCurve(STFReader stf)
        {
            ...
            switch (type.ToLower())
            {
                ...
                case "windspeedcontrolled": Control = Controls.WindSpeedControlled; break;
                case "rainintensitycontrolled": Control = Controls.RainIntensityControlled; break;
