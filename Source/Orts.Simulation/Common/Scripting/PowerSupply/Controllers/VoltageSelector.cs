...
{
    public abstract class VoltageSelector
    {
        // Internal members and methods (inaccessible from script)
        internal ScriptedVoltageSelector Host;
        internal ScriptedLocomotivePowerSupply PowerSupply => Host.PowerSupply;

        internal void AttachToHost(ScriptedVoltageSelector host)
        {
            Host = host;
        }
        ...
        public List<VoltageSelectorPosition> Positions => Host.Positions;
