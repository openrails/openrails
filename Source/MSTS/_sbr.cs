...
namespace MSTS
{
    ...
    public class UnicodeFileReader : UnicodeBlockReader
    {
        ...
        {
            f = new MSTS.STFReader(inputStream, filename, encoding);
        }
    ...
    public class UnicodeBlockReader : SBR
    {
        ...
        public override uint ReadFlags() { return f.ReadFlags(); }
        public override int ReadInt() { return f.ReadInt(); }
        public override uint ReadUInt() { return f.ReadUInt(); }
        public override float ReadFloat() { return (float)f.ReadDouble(); }
        public override string ReadString() { return f.ReadToken(); }
