...
using ORTS.Orge.Drawing.Labels;
using ORTS.Orge.UserInterface;
using ORTS.Orge.Editing;
using ORTS.Orge.Editing.Charts;
...
namespace ORTS.Orge
{
    ...
    /// </summary>
    public class RouteGenExtract : Microsoft.Xna.Framework.Game
    {
        ...
        /// </summary>
        public RouteGenExtract(string[] args)
        {
        ...
        protected override void Initialize()
        {
            ...
            RouteGenExtract.Localize(statusBarControl);
            menuControl = new MenuControl(this);
            RouteGenExtract.Localize(menuControl);
        ...
        public void AutoRestorePaths()
        {
            ...
            RouteGenExtract.Localize(fixer);
        ...
        /// <summary>
        /// This is the 'catalog' needed for localization of Orge (meaning translating it to different languages)
        /// </summary>
        ...
        /// Give message to use that Orge needs to be restarted
        /// </summary>
