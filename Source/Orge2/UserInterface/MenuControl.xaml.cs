...
using ORTS.Orge.Drawing; // for colors
namespace ORTS.Orge.UserInterface
{
    ...
    public sealed partial class MenuControl : System.Windows.Controls.UserControl, IDisposable, IPreferenceChanger
    {
        ...
        private RouteGenExtract trackViewer;
        ...
        public MenuControl(RouteGenExtract trackViewer)
        {
        ...
        public void PopulatePaths()
        {
            ...
            paths.Insert(0, RouteGenExtract.catalog.GetString("<Select path>"));
        ...
        public void PopulateStations()
        {
            ...
            stations.Insert(0, RouteGenExtract.catalog.GetString("<Select station>"));
        ...
        public void PopulatePlatforms()
        {
            ...
            platforms.Insert(0, RouteGenExtract.catalog.GetString("<Select platform>"));
        ...
        public void PopulateSidings()
        {
            ...
            sidings.Insert(0, RouteGenExtract.catalog.GetString("<Select siding>"));
        ...
        private void MenuShortcuts_Click(object sender, RoutedEventArgs e)
        {
            ...
            shortcuts.Append(RouteGenExtract.catalog.GetString("ctrl-R\tReload the route\n"));
            shortcuts.Append(RouteGenExtract.catalog.GetString("Q\tQuit\n"));
            shortcuts.Append("\n");
            shortcuts.Append(RouteGenExtract.catalog.GetString("=\tZoom-in (and keep zooming)\n"));
            shortcuts.Append(RouteGenExtract.catalog.GetString("shift-=\tZoom-in\n"));
            shortcuts.Append(RouteGenExtract.catalog.GetString("-\tZoom-out (and keep zooming)\n"));
            shortcuts.Append(RouteGenExtract.catalog.GetString("shift--\tZoom-out\n"));
            shortcuts.Append(RouteGenExtract.catalog.GetString("Z\tZoom to tile\n"));
            shortcuts.Append(RouteGenExtract.catalog.GetString("M\tToggle zoom center\n"));
            shortcuts.Append(RouteGenExtract.catalog.GetString("R\tZoom reset\n"));
            shortcuts.Append(RouteGenExtract.catalog.GetString("L\tAdd label\n"));
            shortcuts.Append("\n");
            shortcuts.Append(RouteGenExtract.catalog.GetString("shift-C\t\tShift center to current mouse location\n"));
            shortcuts.Append(RouteGenExtract.catalog.GetString("left arrow\tShift left\n"));
            shortcuts.Append(RouteGenExtract.catalog.GetString("down arrow\tShift down\n"));
            shortcuts.Append(RouteGenExtract.catalog.GetString("right arrow\tShift right\n"));
            shortcuts.Append(RouteGenExtract.catalog.GetString("up arrow\t\tShift up\n"));
            shortcuts.Append("\n");
            shortcuts.Append(RouteGenExtract.catalog.GetString("F5\tShow speed-limits\n"));
            shortcuts.Append(RouteGenExtract.catalog.GetString("shift-F5\tShow mileposts\n"));
            shortcuts.Append(RouteGenExtract.catalog.GetString("F6\tShow terrain\n"));
            shortcuts.Append(RouteGenExtract.catalog.GetString("ctrl-F6\tShow DM terrain\n"));
            shortcuts.Append(RouteGenExtract.catalog.GetString("shift-F6\tShow terrain patch lines\n"));
            shortcuts.Append(RouteGenExtract.catalog.GetString("F7\tshow signals\n"));
            shortcuts.Append(RouteGenExtract.catalog.GetString("F8\tShow platforms\n"));
            shortcuts.Append(RouteGenExtract.catalog.GetString("shift-F8\tShow platform-names\n"));
            shortcuts.Append(RouteGenExtract.catalog.GetString("F9\tShow sidings\n"));
            shortcuts.Append(RouteGenExtract.catalog.GetString("shift-F9\tShow siding-names\n"));
            shortcuts.Append(RouteGenExtract.catalog.GetString("F10\tHighlight tracks\n"));
            shortcuts.Append(RouteGenExtract.catalog.GetString("shift-F10\tHighlight items\n"));
            shortcuts.Append(RouteGenExtract.catalog.GetString("F11\tShow path\n"));
            shortcuts.Append(RouteGenExtract.catalog.GetString("shift-F11\tShow raw path\n"));
            shortcuts.Append("\n");
            shortcuts.Append(RouteGenExtract.catalog.GetString("C\t\tShift to center of current path node\n"));
            shortcuts.Append(RouteGenExtract.catalog.GetString("PgUp\t\tShow more of the path\n"));
            shortcuts.Append(RouteGenExtract.catalog.GetString("PgDn\t\tShow less of the path\n"));
            shortcuts.Append(RouteGenExtract.catalog.GetString("shift-PgUp\tShow the full path\n"));
            shortcuts.Append(RouteGenExtract.catalog.GetString("shift-PgDn\tShow only start point of path\n"));
            shortcuts.Append(RouteGenExtract.catalog.GetString("E\t\tPlace end-point\n"));
            shortcuts.Append(RouteGenExtract.catalog.GetString("W\t\tPlace a wait-point\n"));
            shortcuts.Append(RouteGenExtract.catalog.GetString("ctrl-Z\t\tUndo in path editor\n"));
            shortcuts.Append(RouteGenExtract.catalog.GetString("ctrl-Y\t\tRedo in path editor\n"));
            shortcuts.Append("\n");
            shortcuts.Append(RouteGenExtract.catalog.GetString("alt-?\t\tVarious keys to open submenus\n"));
            MessageBox.Show(shortcuts.ToString(), RouteGenExtract.catalog.GetString("Keyboard shortcuts"));
        }

        private void MenuAbout_Click(object sender, RoutedEventArgs e)
        {
            StringBuilder about = new StringBuilder();
            about.Append(RouteGenExtract.catalog.GetString("This is ORTS Orge, version "));
            about.Append(RouteGenExtract.TrackViewerVersion);
            about.Append("\n");
            about.Append(RouteGenExtract.catalog.GetString("It is a 'Contribution' to ORTS, and as such\n"));
            about.Append(RouteGenExtract.catalog.GetString("not an integral part of ORTS."));
            MessageBox.Show(about.ToString(), "Orge");
        }
        ...
        private void MenuDocumentation_Click(object sender, RoutedEventArgs e)
        {
            ...
            documentation.Append(RouteGenExtract.catalog.GetString("Documentation is available"));
            documentation.Append(": ");
            documentation.Append(website);
            documentation.Append(" (");
            documentation.Append(RouteGenExtract.catalog.GetString("Right column → Open Rails Trackviewer"));
            documentation.Append(")\n");
            documentation.Append(RouteGenExtract.catalog.GetString("Do you want to go to the website?"));
            MessageBoxResult result = MessageBox.Show(documentation.ToString(),
                RouteGenExtract.catalog.GetString("Documentation"),
        ...
        private void MenuSearchTrackNode_Click(object sender, RoutedEventArgs e)
        {
            ...
            RouteGenExtract.Localize(searchControl);
        ...
        private void MenuShowOtherPaths_Click(object sender, RoutedEventArgs e)
        {
            ...
            RouteGenExtract.Localize(otherPathsWindow);
