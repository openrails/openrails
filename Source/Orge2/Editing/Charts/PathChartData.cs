...
namespace ORTS.Orge.Editing.Charts
{
    /// <summary>
    ...
    public class PathChartData
    {
        ...
        public PathChartData(ORTS.Orge.Drawing.RouteData routeData)
        {
    ...
    class TrackItemManager
    {
        ...
        public TrackItemManager(ORTS.Orge.Drawing.RouteData routeData)
        {
            this.trackDB = routeData.TrackDB;
            this.tsectionDat = routeData.TsectionDat;
