    ...
    static class DrawColors
    {
        ...
        private static void SetPathColors(IPreferenceChanger preferenceChanger)
        {
            ...
            brokenPath.MakeIntoUserPreference(preferenceChanger, "brokenpath",
                RouteGenExtract.catalog.GetString("Select broken path color"));
            ...
            pathMain.MakeIntoUserPreference(preferenceChanger, "pathmain", 
                RouteGenExtract.catalog.GetString("Select path color (main)"));
            ...
            pathSiding.MakeIntoUserPreference(preferenceChanger, "pathsiding", 
                RouteGenExtract.catalog.GetString("Select path color (siding)"));
        ...
        private static void SetTrackColors(IPreferenceChanger preferenceChanger)
        {
            ...
            trackColorColouredStraight.MakeIntoUserPreference(preferenceChanger, "track_colored_straight", RouteGenExtract.catalog.GetString("Select color for multi-colored straight tracks"), true);
            trackColorColouredCurved.MakeIntoUserPreference(preferenceChanger, "track_colored_curved", RouteGenExtract.catalog.GetString("Select color for multi-colored curved tracks"), true);
            trackColorFlat.MakeIntoUserPreference(preferenceChanger, "track_flat", RouteGenExtract.catalog.GetString("Select color for mono-colored tracks"), true);
            trackColorTerrain.MakeIntoUserPreference(preferenceChanger, "track_terrain", RouteGenExtract.catalog.GetString("Select color for tracks on terrain"));

            roadTrackColorColouredStraight.MakeIntoUserPreference(preferenceChanger, "road_colored_straight", RouteGenExtract.catalog.GetString("Select color for multi-colored straight roads"), true);
            roadTrackColorColouredCurved.MakeIntoUserPreference(preferenceChanger, "road_colored_curved", RouteGenExtract.catalog.GetString("Select color for multi-colored curved roads"), true);
            roadTrackColorFlat.MakeIntoUserPreference(preferenceChanger, "road_flat", RouteGenExtract.catalog.GetString("Select color for mono-colored roads"), true);
            roadTrackColorTerrain.MakeIntoUserPreference(preferenceChanger, "road_terrain", RouteGenExtract.catalog.GetString("Select color for roads on terrain"));
        }
        ...
        private static void SetBackgroundColors(IPreferenceChanger preferenceChanger)
        {
            ...
            changingBackgroundColor.MakeIntoUserPreference(preferenceChanger, "background", 
                RouteGenExtract.catalog.GetString("Select background color"));
        ...
        private static void SetBasicColors(IPreferenceChanger preferenceChanger)
        {
            ...
            basicColor.MakeIntoUserPreference(preferenceChanger, "text",
                RouteGenExtract.catalog.GetString("Select text color"));
        ...
        private static void SetItemColors(IPreferenceChanger preferenceChanger)
        {
            ...
            itemColor.MakeIntoUserPreference(preferenceChanger, "text", 
                RouteGenExtract.catalog.GetString("Select item text color"));
            ...
            itemColor.MakeIntoUserPreference(preferenceChanger, "junction", 
                RouteGenExtract.catalog.GetString("Select junction color"));
            ...
            itemColor.MakeIntoUserPreference(preferenceChanger, "endnode", 
                RouteGenExtract.catalog.GetString("Select endnode color"));
            ...
            itemColor.MakeIntoUserPreference(preferenceChanger, "siding", 
                RouteGenExtract.catalog.GetString("Select siding color"));
            ...
            itemColor.MakeIntoUserPreference(preferenceChanger, "crossing", 
                RouteGenExtract.catalog.GetString("Select crossing color"));
            ...
            itemColor.MakeIntoUserPreference(preferenceChanger, "roadcrossing", 
                RouteGenExtract.catalog.GetString("Select road crossing color"));
            ...
            itemColor.MakeIntoUserPreference(preferenceChanger, "speedpost", 
                RouteGenExtract.catalog.GetString("Select speedpost color"));
        ...
        static void SetShadedColors(IPreferenceChanger preferenceChanger)
        {
            ...
            otherPathsReferenceColor.MakeIntoUserPreference(preferenceChanger, "otherPaths",
                RouteGenExtract.catalog.GetString("Select other-paths color"));
        }
