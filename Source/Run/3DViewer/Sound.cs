...
/////////////////////////////////////////////////////////
    ...
    public class SoundSource : GameComponent
    {
        /// <summary>
        ...
        public SoundSource(Viewer viewer, TrainCarSimulator car, string smsFilePath)
            : base(viewer)
        {
            Car = car;
        ...
        /// <param name="smsFilePath"></param>
        public SoundSource(Viewer viewer, WorldLocation worldLocation, string smsFilePath)
            : base(viewer)
        {
        ...
        public Viewer Viewer;                 // the listener is connected to this viewer
        public TrainCarSimulator Car = null;          // the sound may be from a train car
        ...
        public void Initialize(Viewer viewer, WorldLocation worldLocation, string smsFilePath)
        {
            Viewer = viewer;
...
/////////////////////////////////////////////////////////
    ...
    public class SoundStream
    {
        ...
        public void Update( IrrKlang.Vector3D IRRposition )
        {
            ...
            TrainCarSimulator car = SoundSource.Car;
        ...
        /// <param name="car"></param>
        /// <returns></returns>
        private float ReadValue(MSTS.VolumeCurve.Controls control, TrainCarSimulator car)
        {
            switch (control)
            {
        ...
        public void Play3D( bool repeat, IrrKlang.ISoundSource iSoundSource )
        {
            ...
            Viewer viewer = SoundSource.Viewer;
...
/////////////////////////////////////////////////////////
    ...
    public class ORTSRandomTrigger
    {
        ...
        public ORTSRandomTrigger(SoundStream soundStream, MSTS.Random_Trigger smsData)
        {
            ...
            StartSeconds = Simulator.SecondsRunning;
            UpdateTriggerAtSeconds();
        }

        public void TryTrigger()
        {
            if (Simulator.SecondsRunning > triggerAtSeconds)
            {
                SoundCommand.Run();
                float volume = (float)Simulator.Random.NextDouble() * (SMS.Volume_Max - SMS.Volume_Min) + SMS.Volume_Min;
                SoundStream.Volume = volume;
        ...
        private void UpdateTriggerAtSeconds()
        {
            ...
            triggerAtSeconds = Simulator.SecondsRunning + interval;
        }
